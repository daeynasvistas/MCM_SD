...
var _banco = __webpack_require__(16);
...
exports.default = app => {
  ...
  app.use('/api/v1/bancos', _banco2.default);
};
...
var _banco = __webpack_require__(14);

var bancoController = _interopRequireWildcard(_banco);

var _auth = __webpack_require__(5);

var _banco2 = __webpack_require__(17);

var _banco3 = _interopRequireDefault(_banco2);
...
exports.default = {
  createBanco: {
    body: {
      Denominacao_da_Instituicao: _joi2.default.string().min(3).required(),
      Denominacao_do_Establecimento: _joi2.default.string().min(3).required()
    }
  }
};
